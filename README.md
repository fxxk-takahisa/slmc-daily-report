...
### ✅ v2.1.4 最新機能（2025-11-16）🎉

#### 1. **週次・月次・累計レポートのフォーマット統一**
- ✨ 週次・月次・累計レポートを日次レポートと同じフォーマットで出力
- 集計データではなく、各日の個別データを日次形式で表示
- レポート内容がより詳細で分かりやすく
- メール送信も可能に
...
### Version 2.1.4 (2025-11-16) 🎉 最新
- ✨ **週次・月次・累計レポートのフォーマット統一**: 日次レポートと同じ形式で各日のデータを個別表示
...
**🎊 Version 2.1.4 完成！CSVエクスポートとレポートフォーマット統一でさらに便利に。GitHub Pagesでの公開を強く推奨します。**
